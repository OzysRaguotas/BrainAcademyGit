...
namespace LibraryUser
{
    ...
    public class LibraryUser : ILibraryUser
    {
        ...
        public LibraryUser(string first, string last, string id, string phone, int booklimit)
        {
            FirstName = first;
            LastName = last;
            Id = id;
    ...
    class Program
    {
        ...
        {
            LibraryUser user1 = new LibraryUser(), user2 = new LibraryUser("Maria", "Ivanenko", "CK789456", "+380447777777", 2);
